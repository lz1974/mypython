...
class Test(unittest.TestCase):
    ...
    # 注意，方法的入参为self
    # 可使用unittest.TestCase类下面的各种断言方法用于对测试结2果的判断
    # 可定义多个测试用例
    # 最重要的就是该部分
    def test_case1(self):
        # print
        self.number
        self.assertEqual(self.number, 10, msg='输入非10的数字')
    ...
    # def test_case3(self):
        #   print
    #  self.number
    #   self.assertEqual(self.number, 30, msg='Y
    #     our input is not 30')
...
if __name__ == '__main__':
    ...
    # 执行顺序是命名顺序：先执行test_case1，再执行test_case21
  unittest.main()
